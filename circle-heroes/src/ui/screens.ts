 ...
 * §2026-08-02 재설계: 임무별 점수가 다르고(15~25점) 구간도 40/70/100 3단계뿐이라 임무를
 * 여러 개 모아야 다음 구간이 열린다(예전엔 임무 개수==구간 개수로 1:1이라 사실상 임무 하나마다
 * 보상이 자동으로 2배였음). 개별 임무 보상·전체완료 보너스와 별개인 3번째 보상 레이어 —
 * 레퍼런스(두 벤치마크 게임 공통)의 "상단 마일스톤 트랙" 문법을 그대로 반영. 일일/주간이 구조가
 * 완전히 같아 렌더러 하나를 공유한다 */
