...
| 폴더 | 용도 | 규격 |
|---|---|---|
| `characters/` | 전투 캐릭터 SD (**플레이 가능 영웅만**) | 512×512, PNG 투명 배경 |
| `monsters/` | 몬스터·스테이지 보스 등 **적 전용**(플레이 불가) | 512×512 (보스류는 768×768), PNG 투명 배경 |
| `cards/` | 소환/도감용 일러스트 | 1024×1536 |
| `backgrounds/` | 전투 배경 | 1080×1920 |
| `icons/` | 골드/보석 등 아이콘 | 128×128, PNG 투명 배경 |
| `effects/` | 전투 이펙트(타격·스킬 이펙트) | 256×256, PNG 투명 배경, 루프 없는 단일 프레임(또는 4~6프레임 스프라이트시트) |
