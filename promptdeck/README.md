...
- Free tier: up to 3 saved prompts. **PromptDeck Pro** (one-time purchase via Gumroad license key, verified client-side against Gumroad's public license API — no server of our own): unlimited prompts + one-click import of the full 15-prompt [AI Board of Directors](https://glowhalo.gumroad.com/l/ai-board-of-directors) prompt pack.
