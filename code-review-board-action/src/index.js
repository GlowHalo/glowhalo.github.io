...
async function main() {
  ...
  let footer = '\n---\n_🔍 [Code Review Board](https://glowhalo.gumroad.com/l/code-review-board) — three independent AI reviewers, no code stored, nothing sent anywhere except the Anthropic API key you provided.';
