...
> **(2026-08-08, 재구성 진행 중)** `../pixel-ai-office/`를 여러 계열사를 조망하는 지주회사 HQ 대시보드로 격상하고, `ai-office/`는 그 하위의 정연 사장 오피스 뷰로 재편할 계획이다. `pixel-ai-office`가 이미 자체적으로 "새사업 스튜디오"(탐색형 계열사 하나)로 설계돼 있어 정연 체제와 개념이 겹치는 부분을 어떻게 합칠지 확인 중 — 확정되면 이 섹션을 갱신한다.
