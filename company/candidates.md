...
|---|---|---|---|---|---|
| A1 | AI 프롬프트팩/노션·시트 템플릿 스토어 | Gumroad/Etsy (개인판매, 사업자등록 불요) | 0원 | CSO | 🟢 **실행중** — Gumroad 상품 API로 등록 완료(비공개 draft), 회장 최종 공개 승인 대기 (담당: CEO 정연, [실행플랜](execution/A1-실행플랜.md), [업로드 기록](execution/products/04-gumroad-업로드-준비.md)) |
