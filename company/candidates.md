...
|---|---|---|---|---|---|
| A1 | AI 프롬프트팩/노션·시트 템플릿 스토어 | Gumroad/Etsy (개인판매, 사업자등록 불요) | 0원 | CSO | 🟢 **실행중** — Gumroad 상품+커버 3장까지 API로 등록 완료(비공개 draft), 환불정책 확인 후 회장 최종 공개 승인만 남음 (담당: CEO 정연, [실행플랜](execution/A1-실행플랜.md), [업로드 기록](execution/products/04-gumroad-업로드-준비.md)) |
| A2 | AI 마이크로 SaaS / 크롬 확장 프로그램 | 앱스토어/확장프로그램 스토어 개인 등록 | ~7천원 | CTO | ⚪ 대기 (2순위) |
