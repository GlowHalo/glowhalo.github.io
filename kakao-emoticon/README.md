...
- **A4(새침냥이, 가칭)**: A3 심사 대기 기간을 활용한 두 번째 시리즈. **2026-08-15 착수 — 정지형 32종 아트워크 전부 완료.** 다음은 아이콘 제작 + 실제 제출(회장의 카카오톡 본인확인 1회만 있으면 이후는 예슬이 진행). 상세: [`execution/A4-second-series.md`](execution/A4-second-series.md)
