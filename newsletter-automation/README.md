...
- [ ] **⚠️ 신규 발견 — 스티비도 무료(스타터) 플랜에선 "유료 구독 주소록" 생성이 안 됨.** 로그인해서 실제로 "유료 구독 주소록 만들기"를 눌러보니 업그레이드 안내 모달만 뜨고 무료로 진행하는 경로가 없었고, 요금제 페이지 확인 결과 **"유료 구독" 기능은 스탠다드 플랜(월 8,900원, 부가세 포함)부터 포함**. 기존 조사("스티비는 무료로 유료구독 가능")는 문서만 보고 낸 결론이라 틀렸음 — `candidates.md` 정정 반영. **회장 확인 필요**: 월 8,900원 결제해서 스탠다드로 업그레이드할지, 무료(스타터)로 우선 무료 뉴스레터만 발행하다 구독자 반응 보고 유료화할지 결정 요청.
