...
| 나다컴퍼니4 신설 | 진단 상품화 계열사 — 회장의 버크만 시그니처 디브리퍼 자격을 근간으로 시작, 이후 무자격 진단군으로 라인업 확장 | ✅ 대표 "채원" 선임(2026-08-09). 기존 `birkman-automation/`(구매대행+AI디브리핑 파이프라인, 버크만 전용 확인 게이트 — [`.claude/rules/birkman.md`](../.claude/rules/birkman.md))이 이 계열사의 기술 기반. **최종 목표는 완전 자동화(회장 개입 0)지만, 브랜딩·스토어 개설·플랫폼 확장·상품 컨셉·상세페이지 등 초기 세팅은 회장과 긴밀히 협의하며 진행** — 다른 계열사보다 초기 자율성 낮게 시작. 브랜드 "Reflect Lab" 확정, 상품 1·2번(3번 챗봇은 보류) 확정(2026-08-10) — 문서는 [`company4/`](../company4/README.md), 무자격 진단 후보는 [`company4/candidates.md`](../company4/candidates.md) |
...
| 나다컴퍼니5 신설 | 유튜브 콘텐츠 계열사 — 회장이 개인적으로 진행하던 "몬스터트럭 파닉스"(유아 한글/알파벳 파닉스 시리즈)를 승격형으로 편입 | ✅ 대표 "라온" 선임(2026-08-12). ㅏ회차 업로드 완료, 나머지 65회차(모음 21·자음 19·알파벳 26 총 66회차 계획) 제작 재개. 문서는 [`company5/`](../company5/README.md), 원본 기획은 Notion(몬스터트럭 파닉스 워크스페이스) |
| 나다컴퍼니6 신설 | 앱 개발·배포 계열사 — 회장이 개인적으로 만들어 온 웹앱/유틸(아기랑 갈곳·체크노트·배당현황·KPC 코칭챗봇·Circle Heroes 등)을 포트폴리오로 승격 편입, 신규 앱 개발도 이어감 | ✅ 대표 "시우" 선임(2026-08-12). 이미 다른 계열사 상업 트랙에 편입된 앱(예: 나다컴퍼니1 A2 PromptDeck)은 제외 — 아직 특정 사업 트랙에 안 속한 앱만 편입. 문서는 [`company6/`](../company6/README.md) |
| 나다컴퍼니7 신설 | 쿠팡파트너스 계열사 — 나다컴퍼니2(하윤)의 C1을 분사, 하윤은 니치API 라인에 전념 | ✅ 대표 "도현" 선임(2026-08-12). 디스코드 채널·웹훅·수동 브릿지 폼까지 이관 완료, 누적매출 15만원 달성 후 API 완전자동 전환이 목표. 문서는 [`company7/`](../company7/README.md) |
| 나다컴퍼니8 신설 | 카카오톡 이모티콘 계열사 — 나다컴퍼니1(정연)의 A3를 분사, 정연은 템플릿 라인(A1)에 전념 | ✅ 대표 "예슬" 선임(2026-08-12). 정지형 32종 제작·제출 완료, 카카오 심사중(결과 2~4주 대기) 상태 그대로 이관. 문서는 [`company8/`](../company8/README.md) |
| 나다컴퍼니9 신설 | 신사업 서칭 계열사 — 백지상태 탐색이지만 방법론이 다름: 10인 분석가 패널이 각자 스캔 → 시장크기·홍보채널접근성·자동화적합성 3단계 필터로 종합 | ✅ 대표 "다연" 선임(2026-08-12). **Round 1 완료** — 10인 패널 26개 후보 → 자동화 교차검증 → Tier A 3건 확정(E1 웨어러블 헬스데이터 AI 웰니스 리포트, E2 니치 AI 뉴스레터, E3 POD 굿즈 스토어). **E2는 나다컴퍼니10(뉴스레터/Beehiiv)과 방향이 정확히 겹침** — 아래 나다컴퍼니10 행 참고, 회장 판단 필요. 문서는 [`company9/`](../company9/README.md), 후보는 [`company9/candidates.md`](../company9/candidates.md) |
| 나다컴퍼니10 신설 | 뉴스레터 자동화 계열사 — 신설 시 회장 지정 플랫폼은 Beehiiv | ✅ 대표 "은우" 선임(2026-08-12). **A5(스티비 뉴스레터, 콘텐츠 완성)를 나다컴퍼니10이 흡수하는 것으로 회장이 확정** — A1 템플릿 라인처럼 정연 소관에서 벗어나 은우 소관으로 이관. 다만 회장이 "유료 플랫폼은 지금 쓰고 싶지 않다"고 해 **플랫폼은 재검토 중**(스티비/Beehiiv/Substack/Ghost/Kit/Buttondown/MailerLite 7곳 비교 완료, 현재안은 스티비) — [`company10/candidates.md`](../company10/candidates.md). 나다컴퍼니9 E2는 이 흡수로 사실상 정리됨. 문서는 [`company10/`](../company10/README.md) |
| 나다컴퍼니11 신설 | 신사업 검토 계열사 — 나다컴퍼니9보다 더 급진적인 방법론: 20인 전문가가 기존 내역 무시하고 각자 아이디어 제안 → 교차 토론 → **최다 지지를 받은 아이디어의 제안자가 대표로 취임**해 그 사업을 직접 이끔 | ✅ 대표 "이든" 선임(2026-08-12). **Round 1 완료** — 20인 전문가 독립 제안 → 교차 투표(20표 중 14표 획득)로 "AI 회의록 자동정리·액션아이템 트래커 SaaS"(사업명 "브리프AI")가 압도적 승리. 문서는 [`company11/`](../company11/README.md), 투표 결과는 [`company11/candidates.md`](../company11/candidates.md) |
| 나다컴퍼니12 신설 | 사업 아이디어 상담 계열사 — 나다컴퍼니9·11(능동 탐색)과 달리 회장이 아이디어를 가져올 때만 움직이는 상시 대기형 | ✅ 대표 "지호" 선임(2026-08-12). 아이디어 접수 시 다른 계열사 candidates.md와 중복부터 확인하는 게 첫 절차. 문서는 [`company12/`](../company12/README.md) |
