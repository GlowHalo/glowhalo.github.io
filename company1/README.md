...
| 나다컴퍼니11 신설 | 신사업 검토 계열사 — 나다컴퍼니9보다 더 급진적인 방법론: 20인 전문가가 기존 내역 무시하고 각자 아이디어 제안 → 교차 토론 → **최다 지지를 받은 아이디어의 제안자가 대표로 취임**해 그 사업을 직접 이끔 | ✅ 방법론 확정(2026-08-12), 대표는 Round 1 토론 결과로 선정 예정(아직 미정). 문서는 [`company11/`](../company11/README.md) |
