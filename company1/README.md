...
| 나다컴퍼니9 신설 | 신사업 서칭 계열사 — 백지상태 탐색이지만 방법론이 다름: 10인 분석가 패널이 각자 스캔 → 시장크기·홍보채널접근성·자동화적합성 3단계 필터로 종합 | ✅ 대표 "다연" 선임(2026-08-12). Round 1 착수 예정. 문서는 [`company9/`](../company9/README.md) |
| 나다컴퍼니10 신설 | 뉴스레터 자동화 계열사 — 회장 지정 플랫폼은 Beehiiv | ✅ 대표 "은우" 선임(2026-08-12). 나다컴퍼니1 A5(스티비 뉴스레터, 콘텐츠 완성)와의 관계 정리가 첫 과제. 문서는 [`company10/`](../company10/README.md) |
