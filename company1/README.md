...
| 나다컴퍼니9 신설 | 신사업 서칭 계열사 — 백지상태 탐색이지만 방법론이 다름: 10인 분석가 패널이 각자 스캔 → 시장크기·홍보채널접근성·자동화적합성 3단계 필터로 종합 | ✅ 대표 "다연" 선임(2026-08-12). **Round 1 완료** — 10인 패널 26개 후보 → 자동화 교차검증 → Tier A 3건 확정(E1 웨어러블 헬스데이터 AI 웰니스 리포트, E2 니치 AI 뉴스레터, E3 POD 굿즈 스토어). E2는 A1 A5(뉴스레터)와 방향 일치 신호 확인 — 재활성화 여부 회장 판단 대기. 문서는 [`company9/`](../company9/README.md), 후보는 [`company9/candidates.md`](../company9/candidates.md) |
