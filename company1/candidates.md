...
|---|---|---|---|---|---|
| A1 | AI 프롬프트팩/노션·시트 템플릿 스토어 | Gumroad 기준선 + **다등록 전략**(Etsy·Whop·Lemon Squeezy·SendOwl 등, 전부 개인판매·사업자등록 불요) | 0원 | CSO | 🟢 **노션 템플릿 라인 3종→8종 확장(2026-08-12, 1차 배치)** — 기존 3종([AI Board of Directors](https://tossneon.gumroad.com/l/ai-board-of-directors)·[Investor Panel](https://tossneon.gumroad.com/l/investor-panel)·[Code Review Board](https://tossneon.gumroad.com/l/code-review-board))에 신규 5종([Marketing Copy Board](https://tossneon.gumroad.com/l/marketing-copy-board)·[Pricing Council](https://tossneon.gumroad.com/l/pricing-council)·[Hiring Panel](https://tossneon.gumroad.com/l/hiring-panel)·[Feature Prioritization Board](https://tossneon.gumroad.com/l/feature-prioritization-board)·[Cold Outreach Board](https://tossneon.gumroad.com/l/cold-outreach-board)) 추가 — 전부 $11~18, 할인코드 WELCOME2, 커버·리시트·발행까지 완료. 20종 목표로 2·3차 배치(11종) 이어서 진행 중. 유통채널 확장은 Notion 마켓플레이스 "In Review", Whop 가입 완료, Lemon Squeezy·SendOwl은 여전히 회장 액션 대기(각각 신원인증·이메일 인증). **매출 여전히 0원** — 확인되는 즉시 최우선 보고. 진행 로그는 [A1-gumroad-대량생산-자동화.md](execution/A1-gumroad-대량생산-자동화.md), 신규 라인 상세는 [products/11-notion-line-3to20-배치1.md](execution/products/11-notion-line-3to20-배치1.md) |
