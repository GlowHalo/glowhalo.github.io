...
| A3 | 카카오톡 이모티콘 | 카카오 이모티콘 스튜디오 (개인 창작자, 정산은 월단위 자동입금으로 추정) | ~10만원 | CMO | 🔵 **2026-08-12 회장 지시로 나다컴퍼니1(정연) 담당에서 별도 사업부로 이관.** 정연은 이제 A1(템플릿 제작)에 집중. 이관 시점 상태: 카카오 심사중(2026-08-11 23:39 제출), 아트워크 32종·스크립트·제출 가이드 전부 완료해 인계 — 상세 인수인계 문서: [execution/A3-kakao-emoticon.md](execution/A3-kakao-emoticon.md#-인수인계--2026-08-12-별도-사업부로-이관) |
