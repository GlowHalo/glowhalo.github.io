...
|---|---|---|---|---|---|
| A1 | AI 프롬프트팩/노션·시트 템플릿 스토어 | Gumroad 기준선 + **다등록 전략**(Etsy·Whop·Lemon Squeezy·SendOwl 등, 전부 개인판매·사업자등록 불요) | 0원 | CSO | 🟡 **3개 상품 발행, 유통채널 확장 중(2026-08-09)** — 1호 [AI Board of Directors](https://tossneon.gumroad.com/l/ai-board-of-directors), 2호 [Investor Panel](https://tossneon.gumroad.com/l/investor-panel), 3호 [Code Review Board](https://tossneon.gumroad.com/l/code-review-board)(전부 $11~18, 할인코드 WELCOME2) 발행 완료. Notion 마켓플레이스 판매 신청 제출("In Review"), Whop 가입 완료, Lemon Squeezy는 API 키 확보했으나 신원인증(Activate Store) 단계에서 회장 액션 대기, SendOwl은 이메일 인증 단계 대기. **매출 여전히 0원** — 확인되는 즉시 최우선 보고. 진행 로그는 [A1-gumroad-대량생산-자동화.md](execution/A1-gumroad-대량생산-자동화.md) |
| A2 | AI 마이크로 SaaS / 크롬 확장 프로그램 | Gumroad 라이선스 키(프리미엄 잠금) + 브라우저 확장스토어 무료배포(Firefox Add-ons·itch.io·Chrome 웹스토어) | ~7천원(Chrome $5, 아직 미착수) | CTO | 🟢 **대부분 완료(2026-08-09)** — PromptDeck 코드 완성, **Gumroad `promptdeck-pro` 라이선스 상품 발행 완료**(하네스 차단이었던 항목이 그새 풀려있던 걸 재확인 후 직접 생성 — 지난 라운드 "회장 액션 필요" 기록이 낡은 정보였음), **Firefox Add-ons 실제 제출 완료**(Mozilla 리뷰어 심사 대기), **itch.io 공개 완료**. 남은 건 Chrome 웹스토어($5, 미착수)와 라이선스 검증 실사용 테스트뿐. 상세: [execution/A2-promptdeck.md](execution/A2-promptdeck.md) |
| A3 | 카카오톡 이모티콘 | 카카오 이모티콘 스튜디오 (개인 창작자, 정산은 월단위 자동입금으로 추정) | ~10만원 | CMO | 🟢 **콘텐츠 100% 완성, 회장이 짬날 때 직접 제출(2026-08-10 확정)** — 아트워크 32종 전부 제작 완료, 제출 가이드도 준비됨. **사장(AI)의 자동 제출은 구조적으로 막힘**(Browserbase가 미국 IP라 카카오 국가차단에 걸림 — 유료 지역프록시($39/월)는 회장이 보류, 무료 대안 3곳(Browserbase 지역프록시·Hyperbrowser·Webshare) 전부 실측 확인 결과 안 됨). **회장이 본인 브라우저로 로그인하면 이 차단 자체가 안 걸려서**, 5~10분이면 직접 제출 가능 — 후순위 보류가 아니라 "완성, 회장 편할 때 제출" 상태로 대기. [execution/A3-kakao-emoticon.md](execution/A3-kakao-emoticon.md) |
