...
export const COMPANY = {
  ...
  titleAccent: "신사업",
  /** 브라우저 탭 제목 */
  pageTitle: "나다컴퍼니1(신사업) — 나다그룹 탐색형 관계사",
  /** 검색·공유될 때 뜨는 설명 */
  description: "사업 기회를 리서치·검증해서 다음 계열사로 키우는 나다그룹의 탐색 전담 관계사",
  /** 창 하단 파일명 느낌의 라벨 */
  windowLabel: "nada_company_1.exe — 사장실",
  /** 일일 브리핑 제목에 들어갈 이름 */
  reportName: "나다컴퍼니1",
} as const;

/** 사장(AI) — 사무실 사장실에 앉아 있는 캐릭터. 나다그룹 탐색 전담, 정연. */
export const CEO_PROFILE = {
  name: "정연",
  callsign: "정연 사장",
  role: "나다컴퍼니1 사장 · 신사업 탐색 · 다음 계열사 준비",
  hair: "#42283a",
  shirt: "#ff8fc0",
  accent: "#fff3b0",
  skin: "#ffdcc4",
  thoughts: [
    "이 사업이 검증되면 전담 대표를 세우고, 나는 다음 회사로 간다.",
