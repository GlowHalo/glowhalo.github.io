...
| 나다컴퍼니2 신설 | 실행 전담 계열사(Gumroad 콘텐츠 업로드 롤) — "계열사 분리 판단 로직" 중 신설 케이스 첫 적용 | ✅ 대표 "하윤" 선임(2026-08-09), 나다컴퍼니1(정연)과 별도 독립 신사업 탐색 트랙 병행. 문서는 [`niche-api/`](../niche-api/README.md). Round 1 스캔 완료(니치 API 프로덕트/RapidAPI Hub 1순위) — [`niche-api/candidates.md`](../niche-api/candidates.md) |
| 나다컴퍼니3 신설 | 자산운용 실험 계열사(코인/주식 중 택일, 초기자본 30만원, 수익 최대화) | ✅ 대표 "은성" 선임(2026-08-09). Round 1 조사 완료 — **코인을 1차 자산군으로 확정**, 저빈도 스윙/알고리즘 전략 + 페이퍼 트레이딩 진행 중. **실거래는 회장이 계좌 개설(본인인증 필수)·매매 권한 범위를 확정하기 전까지 보류.** 문서는 [`asset-management/`](../asset-management/README.md), 비교표는 [`asset-management/candidates.md`](../asset-management/candidates.md) |
...
| A3(카카오톡 이모티콘) 이관 | 나다컴퍼니1(정연) 담당에서 별도 사업부로 이관 — 정연은 A1(템플릿 제작)에 집중 | ✅ 회장 지시(2026-08-12). 이관 시점 상태(카카오 심사중, 아트워크 32종·스크립트·제출가이드 완료)는 [`execution/A3-kakao-emoticon.md`](execution/A3-kakao-emoticon.md#-인수인계--2026-08-12-별도-사업부로-이관)에 인수인계 문서로 정리, `candidates.md` A3 행도 갱신 |
| 나다컴퍼니5 신설 | 유튜브 콘텐츠 계열사 — 회장이 개인적으로 진행하던 "몬스터트럭 파닉스"(유아 한글/알파벳 파닉스 시리즈)를 승격형으로 편입 | ✅ 대표 "라온" 선임(2026-08-12). ㅏ회차 업로드 완료, 나머지 65회차(모음 21·자음 19·알파벳 26 총 66회차 계획) 제작 재개. 문서는 [`youtube-content/`](../youtube-content/README.md), 원본 기획은 Notion(몬스터트럭 파닉스 워크스페이스) |
| 나다컴퍼니6 신설 | 앱 개발·배포 계열사 — 회장이 개인적으로 만들어 온 웹앱/유틸(아기랑 갈곳·체크노트·배당현황·KPC 코칭챗봇·Circle Heroes 등)을 포트폴리오로 승격 편입, 신규 앱 개발도 이어감 | ✅ 대표 "시우" 선임(2026-08-12). 이미 다른 계열사 상업 트랙에 편입된 앱(예: 나다컴퍼니1 A2 PromptDeck)은 제외 — 아직 특정 사업 트랙에 안 속한 앱만 편입. 문서는 [`app-portfolio/`](../app-portfolio/README.md) |
| 나다컴퍼니7 신설 | 쿠팡파트너스 계열사 — 나다컴퍼니2(하윤)의 C1을 분사, 하윤은 니치API 라인에 전념 | ✅ 대표 "도현" 선임(2026-08-12). 디스코드 채널·웹훅·수동 브릿지 폼까지 이관 완료, 누적매출 15만원 달성 후 API 완전자동 전환이 목표. 문서는 [`coupang-partners/`](../coupang-partners/README.md) |
| 나다컴퍼니8 신설 | 카카오톡 이모티콘 계열사 — 나다컴퍼니1(정연)의 A3를 분사, 정연은 템플릿 라인(A1)에 전념 | ✅ 대표 "예슬" 선임(2026-08-12). 정지형 32종 제작·제출 완료, 카카오 심사중(결과 2~4주 대기) 상태 그대로 이관. 문서는 [`kakao-emoticon/`](../kakao-emoticon/README.md) |
| 나다컴퍼니9 신설 | 신사업 서칭 계열사 — 백지상태 탐색이지만 방법론이 다름: 10인 분석가 패널이 각자 스캔 → 시장크기·홍보채널접근성·자동화적합성 3단계 필터로 종합 | ✅ 대표 "다연" 선임(2026-08-12). **Round 1 완료** — 10인 패널 26개 후보 → 자동화 교차검증 → Tier A 3건 확정(E1 웨어러블 헬스데이터 AI 웰니스 리포트, E2 니치 AI 뉴스레터, E3 POD 굿즈 스토어). **E2는 나다컴퍼니10(뉴스레터/Beehiiv)과 방향이 정확히 겹침** — 아래 나다컴퍼니10 행 참고, 회장 판단 필요. 문서는 [`biz-scouting/`](../biz-scouting/README.md), 후보는 [`biz-scouting/candidates.md`](../biz-scouting/candidates.md) |
| 나다컴퍼니10 신설 | 뉴스레터 자동화 계열사 — 신설 시 회장 지정 플랫폼은 Beehiiv | ✅ 대표 "은우" 선임(2026-08-12). **A5(스티비 뉴스레터, 콘텐츠 완성)를 나다컴퍼니10이 흡수하는 것으로 회장이 확정** — A1 템플릿 라인처럼 정연 소관에서 벗어나 은우 소관으로 이관. 다만 회장이 "유료 플랫폼은 지금 쓰고 싶지 않다"고 해 **플랫폼은 재검토 중**(스티비/Beehiiv/Substack/Ghost/Kit/Buttondown/MailerLite 7곳 비교 완료, 현재안은 스티비) — [`newsletter-automation/candidates.md`](../newsletter-automation/candidates.md). 나다컴퍼니9 E2는 이 흡수로 사실상 정리됨. 문서는 [`newsletter-automation/`](../newsletter-automation/README.md) |
| 나다컴퍼니11 신설 | 신사업 검토 계열사 — 나다컴퍼니9보다 더 급진적인 방법론: 20인 전문가가 기존 내역 무시하고 각자 아이디어 제안 → 교차 토론 → **최다 지지를 받은 아이디어의 제안자가 대표로 취임**해 그 사업을 직접 이끔 | ✅ 대표 "이든" 선임(2026-08-12). **Round 1 완료** — 20인 전문가 독립 제안 → 교차 투표(20표 중 14표 획득)로 "AI 회의록 자동정리·액션아이템 트래커 SaaS"(사업명 "브리프AI")가 압도적 승리. 문서는 [`brief-ai/`](../brief-ai/README.md), 투표 결과는 [`brief-ai/candidates.md`](../brief-ai/candidates.md) |
| 나다컴퍼니12 신설 | 사업 아이디어 상담 계열사 — 나다컴퍼니9·11(능동 탐색)과 달리 회장이 아이디어를 가져올 때만 움직이는 상시 대기형 | ✅ 대표 "지호" 선임(2026-08-12). 아이디어 접수 시 다른 계열사 candidates.md와 중복부터 확인하는 게 첫 절차. 문서는 [`biz-consulting/`](../biz-consulting/README.md) |

### 나다컴퍼니3 — 실거래 확인 게이트 ✅ 해제됨 (2026-08-09 수립 → 2026-08-10 해제)

**이 게이트는 종료됐다. 나다컴퍼니3는 현재 Phase 1 실거래 가동 중이며, 은성이 30만원 한도 안에서 건별 승인 없이 매매를 집행한다(무인 예약 루틴 포함).** 현행 정본은 [`asset-management/README.md`](../asset-management/README.md)와 [`asset-management/MODE.md`](../asset-management/MODE.md)다 — 판단이 필요하면 그쪽을 볼 것.
